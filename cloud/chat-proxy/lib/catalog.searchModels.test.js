...
test('catalog - searchModels', async (t) => {
  ...
  global.fetch = async () => ({
    ...
    json: async () => ({
      repairs: [
        { brand: 'iphone', model: 'iPhone 12', repair_type: 'Screen', variant: '', chip: 'screen', price: 100 },
        { brand: 'iphone', model: 'iPhone 13', repair_type: 'Battery', variant: '', chip: 'battery', price: 80 },
        { brand: 'samsung', model: 'Galaxy S21', repair_type: 'Screen', variant: '', chip: 'screen', price: 150 },
      ],
    }),
  });
