...
const html = `
      ...
      <a class="btn btn-wa" href="https://wa.me/12269784666?text=${encodeURIComponent('Hi Nuera Tech! Do you repair: ' + (state_q || 'my device') + '?')}" target="_blank" rel="noopener">Ask on WhatsApp</a>`;
